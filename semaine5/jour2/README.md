...
:star: **Bonus** : installer [phpmyadmin pour nginx](https://linuxcapable.com/how-to-install-phpmyadmin-with-nginx-on-debian-linux/) afin de gérer vos bases de données depuis une interface web
